...
```
As expected, the median is about 10,000 steps per day, but the mean value is `r format(M, digits=2, nsmall=2)`, a slightly lower number.
...
The maximum average number of steps is highlighted in the plot and is found to be `r format(highlight_pt$avg_steps, digits=2, nsmall=2)`, ocuring at about `r paste(strsplit(as.character(as.numeric(paste(as.character(as.numeric(strsplit(as.character(highlight_pt[1]/60),"\\.")[[1]][1])), as.character(as.numeric(strsplit(as.character(highlight_pt[1]/60),"\\.")[[1]][2])*60), sep = "."))),"\\.")[[1]][1], strsplit(as.character(as.numeric(paste(as.character(as.numeric(strsplit(as.character(highlight_pt[1]/60),"\\.")[[1]][1])), as.character(as.numeric(strsplit(as.character(highlight_pt[1]/60),"\\.")[[1]][2])*60), sep = "."))),"\\.")[[1]][2], sep = ":")` on an average day.
